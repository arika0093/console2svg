...
declared commands, writes SVG files, and inserts or updates the associated image links.
...
use the same short form as regular capture options. An omitted `-o` generates a name such
