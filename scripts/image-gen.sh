...
console2svg capture -o "$assets_dir/cmd-loop.svg"          --verbose ./logs/cmd-loop.log         -w 80 -h 20 -v -d windows --timeout 10 -- /usr/games/pipes -t 0 -f 35
# console2svg replay "$assets_dir/cmd-bash-vim-replay.json" -o "$assets_dir/cmd-bash-vim.svg" --verbose ./logs/cmd-bash-vim.log -w 80 -h 20 -v -d -- bash
