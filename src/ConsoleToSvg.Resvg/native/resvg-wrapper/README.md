...
Release and pull-request workflows build all release RIDs. The script determines the native
filename from the host OS and writes it directly to the requested output directory; generated
libraries are not committed.
