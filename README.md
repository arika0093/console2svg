...
```bash
console2svg -w 150 -h 32 -v -c -d macos-pc --timeout 7 --fps 30 -- btop -u 500
```

![console2svg -w 150 -h 32 -v -c -d macos-pc --timeout 7 --fps 30 -- btop -u 500](./assets/cmd-loop.svg)
