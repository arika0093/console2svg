...
console2svg -o ./assets/cmd-hero.svg        --verbose ./logs/cmd-hero.log         -c -d macos-pc -h 10 --opacity 0.95 --background ./assets/image.png  -- oh-my-logo "console2svg" mint --filled --letter-spacing 0
