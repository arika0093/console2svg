...
| `AnimatedRenderingStageBenchmarks` | unique-row catalog preparation, row-definition emission, SMIL row animation emission, prepared-frame write | Separates the hot stages after production replay and frame reduction. |
