...
console2svg -o ./assets/cmd-window.svg      --verbose ./logs/cmd-window.log       -w 100 -c -d macos-pc  -- fastfetch -l small -s os:kernel:uptime:packages:shell:cpu:memory
...
console2svg -o ./assets/cmd-loop.svg          --verbose ./logs/cmd-loop.log         -w 90 -h 24 -v -d windows --timeout 7 -- pipes.sh -t 1 -f 35
