...
![由 console2svg 生成的 console2svg 主视觉图片](/docs/assets/cmd-hero.svg)
...
![console2svg 使用 Nord 主题进行捕获](../assets/cmd-gallery-theme-nord.svg)
...
![console2svg 使用 Cyberpunk 主题进行捕获](../assets/cmd-gallery-theme-cyberpunk.svg)
...
{/* c2s:: -80 -h 14 -d macos-pc -t github-dark -- cat ../../.env */}
![console2svg 自动遮盖示例](../assets/cmd-gallery-mask.svg)
