...
* [System.CommandLine.StaticCompletions](https://github.com/dotnet/command-line-api)
  * [シェル補完](../utilities/shell-completion.md)のサポート。
* [System.IO.Hashing](https://www.nuget.org/packages/System.IO.Hashing/)
  * 高速なハッシュ計算(XxHash3)の実装。
  * ターミナル出力のハッシュ値を計算し、再利用するために使用。
...
* [betterleaks](https://github.com/betterLeaks/betterleaks)
  * 直接的な依存ではありませんが、[定義ファイル](https://github.com/betterleaks/betterleaks/blob/main/config/betterleaks.toml)をベースに[QuickLeaks](./conversion-process/quickleaks.md)を生成しています。
